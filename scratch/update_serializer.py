...
replacement = '''class MemoriaCalculoListSerializer(serializers.ModelSerializer):
...
start = content.find('class MemoriaCalculoListSerializer(serializers.ModelSerializer):')
end = content.find('class TraspasoPresupuestarioSerializer(serializers.ModelSerializer):')
