...
from .views import (
    MemoriaCalculoViewSet, DetallePresupuestoMemoriaViewSet,
    TraspasoViewSet, ModificacionPresupuestariaViewSet
)
...
router.register(r'modificaciones', ModificacionPresupuestariaViewSet, basename='modificacion')
