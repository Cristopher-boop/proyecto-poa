...
class Area(TimeStampedModel):
    ...
    programa = models.ForeignKey(Programa, on_delete=models.CASCADE, related_name='areas', verbose_name="Programa")
    ...
    tipo = models.CharField(max_length=15, choices=TipoArea.choices, default=TipoArea.GERENCIA, verbose_name="Tipo de Área")
    descripcion = models.TextField(blank=True, null=True, verbose_name="Descripción")
    estado = models.BooleanField(default=True, verbose_name="Activo")
...
class Seccion(TimeStampedModel):
    area = models.ForeignKey(Area, on_delete=models.CASCADE, related_name='secciones', verbose_name="Área")
